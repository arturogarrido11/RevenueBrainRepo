...
export async function endCallHandler(
  args: EndCallArgs,
  state: SessionState
): Promise<object> {
...
export const endCallDefinition = {
  ...
  name: "end_call",
  description:
    "End the call after you have said a proper goodbye and the caller has confirmed they have no more questions.",
  parameters: {
    type: "object",
    properties: {
      summary: {
        type: "string",
        description:
          "1-2 sentence summary of what was accomplished in this call.",
      },
    },
    required: ["summary"],
  },
