 ...
 */
export async function captureLeadHandler(args, state) {
...
export const captureLeadDefinition = {
    type: "function",
    name: "capture_lead",
    description: "Save the caller's contact information and the reason for their call. Call this at the end of any conversation where no appointment is being made.",
    parameters: {
        type: "object",
        properties: {
            caller_name: {
            ...
            intent: {
                type: "string",
                description: "What the caller needs help with, in 1-2 sentences.",
            },
            priority: {
                type: "string",
                enum: ["hot", "warm", "low"],
                description: "hot = urgent/ready to buy, warm = interested but not urgent, low = general inquiry.",
            },
        },
        required: ["intent"],
    },
};
//# sourceMappingURL=capture-lead.js.map