 ...
 */
export async function transferCallHandler(args, state) {
...
export const transferCallDefinition = {
    type: "function",
    name: "transfer_call",
    description: "Transfer the caller to a human. Use this when: the caller explicitly asks to speak to a person, the caller is upset or distressed, or the inquiry is too complex for AI to handle.",
    parameters: {
        type: "object",
        properties: {
            reason: {
...
//# sourceMappingURL=transfer-call.js.map